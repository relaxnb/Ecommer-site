                    ...
                    <div class="row">
                        <div class="col-lg-9 offset-lg-3">
                            <div class="main_slider" data-slick='{"arrows": false}'>
                                <div class="slider_item set-bg-image" data-background="{{asset('fontstowa/images/slider/slide-2.jpg')}}">
                                ...
                                <div class="slider_item set-bg-image" data-background="{{asset('fontstowa/images/slider/slide-3.jpg')}}">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
                                ...
                                <div class="slider_item set-bg-image" data-background="{{asset('fontstowa/images/slider/slide-1.jpg')}}">
                                    <div class="slider_content">
                                        <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing</h3>
                                        <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood  <span>Pressure monitor</span></h4>
                                        <p data-animation="fadeInUp2" data-delay=".6s">The best gadgets collection 2021</p>
                                ...
                                <div class="product-area clearfix row">
                                    ...
                                    <div class="grid col-lg-4">
                                        ...
                                        <div class="details">
                                            ...
                                            <p><a href="{{ route('product.details', $product->id) }}">{{ $product->short_discp }}</a></p>
                                            <div class="rating">
                            ...
                            <div class="product-sidebar">
                                        ...
                                        <div class="slider_item">
                                            <div class="small_product_layout">
                                                <a class="item_image" href="shop_details.html">
                                                    <img src="{{ asset ('/uploads/products/preview')}}/{{$product->preview}}" alt="image_not_found">
                                                </a>
                                                <div class="item_content">
                                                    <h3 class="item_title">
                                ...
                                <div class="widget product-add">
                                    <div class="product-img">
                                        <img src="{{ asset ('fontstowa/images/shop/product_img_10.png')}}" alt>
                                    </div>
                                    <div class="details">
                                        <h4>iPad pro</h4>
                            ...
                            <div class="new-arrivals-grids row clearfix">
                                ...
                                <div class="grid col-lg-6">
                                    ...
                                    <div class="details">
                                        ...
                                        <p><a href="#">{{$product->short_discp}}</a></p>
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi>
                    ...
                    <div class="brand_carousel">
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{asset('fontstowa/images/brand/brand_1.png')}}" alt="image_not_found">
                                <img src="{{asset('fontstowa/images/brand/brand_1.png')}}" alt="image_not_found">
                            </a>
                        </div>
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{asset('fontstowa/images/brand/brand_2.png')}}" alt="image_not_found">
                                <img src="{{asset('fontstowa/images/brand/brand_2.png')}}" alt="image_not_found">
                            </a>
                        </div>
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{asset('fontstowa/images/brand/brand_3.png')}}" alt="image_not_found">
                                <img src="{{asset('fontstowa/images/brand/brand_3.png')}}" alt="image_not_found">
                            </a>
                        </div>
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{asset('fontstowa/images/brand/brand_4.png')}}" alt="image_not_found">
                                <img src="{{asset('fontstowa/images/brand/brand_4.png')}}" alt="image_not_found">
                            </a>
                        </div>
                        <div class="slider_item">
                            <a class="product_brand_logo" href="#!">
                                <img src="{{asset('fontstowa/images/brand/brand_5.png')}}" alt="image_not_found">
                                <img src="{{asset('fontstowa/images/brand/brand_5.png')}}" alt="image_not_found">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{asset('fontstowa/images/viewed_products/viewed_product_img_1.png')}}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{asset('fontstowa/images/viewed_products/viewed_product_img_2.png')}}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                            ...
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{asset('fontstowa/images/viewed_products/viewed_product_img_3.png')}}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{asset('fontstowa/images/viewed_products/viewed_product_img_4.png')}}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                            ...
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{asset('fontstowa/images/viewed_products/viewed_product_img_5.png')}}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{asset('fontstowa/images/viewed_products/viewed_product_img_6.png')}}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
