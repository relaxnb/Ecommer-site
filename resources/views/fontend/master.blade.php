...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset ('fontstowa/images/logo/favourite_icon_1.png')}}">

    <!-- fraimwork - css include -->
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/bootstrap.min.css')}}">

    <!-- icon font - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/fontawesome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/stroke-gap-icons.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/icofont.css')}}">

    <!-- animation - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/animate.css')}}">

    <!-- carousel - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/slick-theme.css')}}">

    <!-- popup - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/magnific-popup.css')}}">

    <!-- jquery-ui - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/jquery-ui.css')}}">

    <!-- select option - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/nice-select.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/woocommerce-2.css')}}">

    <!-- custom - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset ('fontstowa/css/style.css')}}">
</head>
...
<body>
    ...
    <div class="body_wrap">
        ...
        <!-- preloader - start -->
        <div id="{{ (Route::CurrentRouteName() == 'index'?'preloader':'adddd')}}"></div>
        <!-- preloader - end -->
                                ...
                                <ul class="header_select_options ul_li">
                                    <li>
                                        <div class="select_option">
                                            <div class="flug_wrap">
                                                <img src="{{ asset('fontstowa/images/flug/flug_uk.png') }}" alt="image_not_found">
                                            </div>
                                            <select class="abc">
                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="{{asset ('fontstowa/images/logo/logo_1x.png') }}" srcset="assets/images/logo/logo_2x.png 2x" alt="logo_not_found">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-3">
                                <ul class="header_icons_group ul_li_right">
                                     <li>
                                         @auth('customerlogin')
                                         <a href="{{ route('profile') }}">{{ Auth::guard('customerlogin')->user()->name}}</a>
                                         @else
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    <li><a href="#!"><img src="{{asset('fontstowa/images/app_store.png')}}" alt="app_store"></a></li>
                                    <li><a href="#!"><img src="{{asset('fontstowa/images/play_store.png')}}" alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <div class="payment_method">
                                <h4>Payment:</h4>
                                <img src="{{asset('fontstowa/images/payments_icon.png')}}" alt="image_not_found">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset ('fontstowa/js/jquery.min.js')}}"></script>
    <script src="{{ asset ('fontstowa/js/popper.min.js')}}"></script>
    <script src="{{ asset ('fontstowa/js/bootstrap.min.js')}}"></script>

    <!-- carousel - jquery plugins collection -->
    <script src="{{ asset ('fontstowa/js/jquery-plugins-collection.js')}}"></script>

    <!-- google map  -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
    <script src="{{ asset ('fontstowa/assets/js/gmaps.min.js')}}"></script>
    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>

    <!-- custom - main-js -->
    <script src="{{ asset ('fontstowa/js/main.js')}}"></script>
