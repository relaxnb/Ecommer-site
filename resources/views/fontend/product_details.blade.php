                ...
                <form action="{{ url('cart/insert') }}" method="POST">
                    @csrf
                        <div class="quantity_wrap">
                            ...
                            <div class="total_price">Total: TK <span class="total_amount">{{ $product_info->after_discount }}</span></div>
                        </div>
                    ...
                    <div class="product-area clearfix">
                        @forelse ($related_products as $related)
                            <div class="grid">
                                ...
                                <div class="details">
                                    <h4><a href="{{ route('product.delete', $related->id)}}">{{$related->product_name}}</a></h4>
                                    <p><a href="{{ route('product.delete', $related->id)}}">{{$related->short_discp}} </a></p>
                                    <div class="rating">
                            ...
                            @empty
                                <h4>No Related Product To Shop</h4>
                        @endforelse
                    </div>
                </div>        
            </div>
