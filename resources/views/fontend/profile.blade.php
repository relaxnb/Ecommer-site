                    ...
                    <div class="row">
                        <div class="col-lg-3 account_menu">
                            <div class="nav account_menu_list flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a href="{{ route('customer_logout')}}" class="nav-link text-start w-100 text-dark">Logout</a>
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div class="tab-content bg-light p-3" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                    ...
                                    <form class="row g-3 p-2" action="{{url('/profile/update')}}" method="POST">
                                        @csrf
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" readonly class="form-control" id="inputEmail4" value="{{ Auth::guard('customerlogin')->user()->email}}">
                                        </div>
                                        <div class="col-md-12">
